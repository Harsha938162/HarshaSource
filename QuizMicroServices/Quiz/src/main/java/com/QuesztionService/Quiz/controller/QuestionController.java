...
public class QuestionController {
	...
	public int validate(@RequestBody List<SubmitforvalidationBean> SubmitforvalidationBeanobj,@PathVariable String Title)
	{
		...
		int result=AddService.validateService(SubmitforvalidationBeanobj, Title);
